...
<div class="grid grid-cols-1 lg:grid-cols-12 gap-8">
        ...
        <div class="sticky top-[88px] space-y-4">
            ...
            <nav class="rounded-xl border border-neutral-200 dark:border-gray-700 bg-white dark:bg-gray-800 overflow-hidden">
                ...
                <div class="divide-y divide-neutral-200">
                    <a href="#profile-info"
                        class="flex items-center gap-3 px-4 py-3 text-sm font-medium text-neutral-900 dark:text-white hover:bg-neutral-50 dark:bg-gray-700">
                        <i data-lucide="user" class="h-5 w-5 text-neutral-400 dark:text-gray-500 dark:text-gray-400"></i>
                        Informations personnelles
                    </a>
                    <a href="#security"
                        class="flex items-center gap-3 px-4 py-3 text-sm font-medium text-neutral-900 dark:text-white hover:bg-neutral-50 dark:bg-gray-700">
                        <i data-lucide="shield" class="h-5 w-5 text-neutral-400 dark:text-gray-500 dark:text-gray-400"></i>
                        Sécurité
                    </a>
    ...
    <main class="lg:col-span-9 space-y-6">
                ...
                <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                    ...
                    <div>
                        ...
                        <input type="text" name="name" id="name" value="{{ old('name', Auth::user()->name) }}"
                            class="mt-1 block w-full rounded-md border border-neutral-200 dark:border-gray-700 px-3 py-2 text-neutral-800 dark:text-gray-100 shadow-sm focus:border-[#073066] dark:focus:border-blue-500 focus:ring-2 focus:ring-[#073066]/20 dark:focus:ring-blue-500/20">
                        @error('name')
        ...
        <!-- Supprimer le compte -->
        <section class="rounded-xl border border-red-200 bg-white dark:bg-gray-800 overflow-hidden">
            <div class="border-b border-red-200 px-6 py-4">
                <h3 class="text-base font-semibold text-red-600">Supprimer le compte</h3>
                <p class="mt-1 text-sm text-neutral-600 dark:text-gray-400">Une fois votre compte supprimé, toutes ses ressources et
                    données seront définitivement effacées.</p>
            </div>
            <div class="p-6">
                <button x-data="" x-on:click.prevent="$dispatch('open-modal', 'confirm-user-deletion')"
                    class="inline-flex items-center gap-2 rounded-md border border-red-200 bg-white dark:bg-gray-800 px-4 py-2 text-sm font-medium text-red-600 hover:bg-red-50 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-red-500/50">
