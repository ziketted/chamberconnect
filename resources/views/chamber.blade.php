        ...
        <div class="absolute bottom-4 left-4 right-4">
            <div class="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-4">
                ...
                <div class="flex gap-2">
                    <button
                        class="inline-flex items-center gap-2 rounded-md border border-white/60 bg-white dark:bg-gray-800/10 px-3 py-2 text-sm font-semibold text-white backdrop-blur hover:bg-white dark:bg-gray-800/20 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white/60"><i
...
<div class="mt-6 rounded-xl border border-neutral-200 dark:border-gray-700 bg-white dark:bg-gray-800 shadow-sm">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-8">
            ...
            <div class="lg:col-span-7 space-y-6">
                <section class="space-y-2">
                    ...
                    <p class="text-sm text-neutral-700 dark:text-gray-300">The Kinshasa Chamber of Commerce connects enterprises with
                ...
                <section class="space-y-3">
                    <div class="flex items-center justify-between">
                        ...
                        <button class="text-sm font-medium text-[#073066] dark:text-blue-400 hover:underline">See all</button>
                    </div>
            ...
            <div class="lg:col-span-5 space-y-6">
                <section class="rounded-xl border border-neutral-200 dark:border-gray-700 bg-white dark:bg-gray-800 p-4 shadow-sm">
                    ...
                    <div class="mt-3 grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm">
                        <div class="space-y-2">
                            <div class="inline-flex items-center gap-2 text-neutral-700 dark:text-gray-300"><i data-lucide="mail"
                                    class="h-4 w-4 text-neutral-500 dark:text-gray-500 dark:text-gray-400"></i> hello@kinchamber.org</div>
                            <div class="inline-flex items-center gap-2 text-neutral-700 dark:text-gray-300"><i data-lucide="phone"
                                    class="h-4 w-4 text-neutral-500 dark:text-gray-500 dark:text-gray-400"></i> +243 800 000 000</div>
                        </div>
                        <div class="space-y-2">
                            <div class="inline-flex items-center gap-2 text-neutral-700 dark:text-gray-300"><i data-lucide="map-pin"
                                    class="h-4 w-4 text-neutral-500 dark:text-gray-500 dark:text-gray-400"></i> 42 Avenue de la Paix, Gombe</div>
                            <div class="inline-flex items-center gap-2 text-neutral-700 dark:text-gray-300"><i data-lucide="globe"
                                    class="h-4 w-4 text-neutral-500 dark:text-gray-500 dark:text-gray-400"></i> kinchamber.org</div>
                        </div>
                    </div>
                    <div class="mt-4 flex items-center gap-3">
                        <button
                            class="inline-flex items-center gap-2 rounded-md border border-neutral-300 bg-white dark:bg-gray-800 px-3 py-2 text-sm font-medium hover:bg-neutral-50 dark:bg-gray-700"><i
                                data-lucide="map" class="h-4 w-4"></i> Get Directions</button>
                        <div
                            class="inline-flex items-center gap-2 rounded-full bg-neutral-100 dark:bg-gray-700 px-3 py-1 text-xs text-neutral-800 dark:text-gray-100">
                            <i data-lucide="shield-check" class="h-4 w-4 text-[#073066] dark:text-blue-400"></i> Accredited</div>
                    </div>
                </section>
                ...
                <section class="rounded-xl border border-neutral-200 dark:border-gray-700 bg-white dark:bg-gray-800 p-4 shadow-sm">
                    ...
                    <div class="mt-3 flex items-center gap-2">
                        <a href="#"
                            class="inline-flex h-9 w-9 items-center justify-center rounded-md border border-neutral-200 dark:border-gray-700 hover:bg-neutral-50 dark:bg-gray-700"
                ...
                <section class="rounded-xl border border-neutral-200 dark:border-gray-700 bg-white dark:bg-gray-800 p-4 shadow-sm">
                    <div class="flex items-center justify-between">
                        <h3 class="text-sm font-semibold tracking-tight" style="letter-spacing:-0.01em;">Partner
                            Companies</h3>
                        <button class="text-xs font-medium text-[#073066] dark:text-blue-400 hover:underline">All partners</button>
                    </div>
                    <div class="mt-3 grid grid-cols-3 gap-3">
                        <div class="rounded-lg border border-neutral-200 dark:border-gray-700 p-3 text-center"><span
            ...
            <article
                ...
                <div class="p-4">
                    <h4 class="text-base font-semibold tracking-tight" style="letter-spacing:-0.01em;">Export Finance
                        Clinic</h4>
                    <p class="mt-1 text-sm text-neutral-600 dark:text-gray-400">1:1 sessions with trade finance experts.</p>
            ...
            <article
                ...
                <div class="p-4">
                    <h4 class="text-base font-semibold tracking-tight" style="letter-spacing:-0.01em;">Regulatory Update
                        Webinar</h4>
                    <p class="mt-1 text-sm text-neutral-600 dark:text-gray-400">Compliance essentials for Q1.</p>
                    <div class="mt-3 flex items-center gap-3 text-xs text-neutral-600 dark:text-gray-400">
                        <span class="inline-flex items-center gap-1"><i data-lucide="calendar" class="h-3.5 w-3.5"></i>
                            Jan 26</span>
                        <span class="inline-flex items-center gap-1"><i data-lucide="clock" class="h-3.5 w-3.5"></i>
        ...
        <div class="rounded-xl border border-neutral-200 dark:border-gray-700 bg-white dark:bg-gray-800 shadow-sm overflow-hidden">
            <div class="border-b border-neutral-200 dark:border-gray-700 px-4 py-3 flex items-center justify-between">
                ...
                <div class="relative">
                    ...
                    <span
                        class="pointer-events-none absolute inset-y-0 right-0 flex items-center pr-2 text-neutral-400 dark:text-gray-500 dark:text-gray-400"><i
                ...
                <table class="min-w-full text-sm">
                    ...
                    <tbody class="divide-y divide-neutral-200">
                        <tr class="hover:bg-neutral-50 dark:bg-gray-700">
                            ...
                            <td class="px-4 py-2 text-[#073066] dark:text-blue-400">amina@kivuagro.com</td>
                            <td class="px-4 py-2">+243 800 111 222</td>
                        </tr>
                        <tr class="hover:bg-neutral-50 dark:bg-gray-700">
                            <td class="px-4 py-2">Lumumba Logistics</td>
                            <td class="px-4 py-2">Jean P.</td>
                            <td class="px-4 py-2 text-[#073066] dark:text-blue-400">jean@lumlog.com</td>
                            <td class="px-4 py-2">+243 800 333 444</td>
                        </tr>
                        <tr class="hover:bg-neutral-50 dark:bg-gray-700">
                            <td class="px-4 py-2">KinTech Labs</td>
                            <td class="px-4 py-2">Chantal M.</td>
                            <td class="px-4 py-2 text-[#073066] dark:text-blue-400">cm@kintechlabs.io</td>
    ...
    <div data-chamber-tab="partners" class="hidden p-4 sm:p-6">
        <div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-4">
            <div class="rounded-lg border border-neutral-200 dark:border-gray-700 bg-white dark:bg-gray-800 p-4 text-center hover:bg-neutral-50 dark:bg-gray-700"><span
