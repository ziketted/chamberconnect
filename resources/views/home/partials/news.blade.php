<section aria-labelledby="news-title" class="space-y-6">
    <div class="flex items-center justify-between">
        ...
        <a href="{{ route('news.index') }}" class="text-sm font-medium text-[#073066] hover:underline">View all</a>
    </div>
    <div class="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
        ...
        <article class="rounded-xl border border-neutral-200 bg-white shadow-sm overflow-hidden hover:shadow-md transition-shadow">
            ...
            <div class="p-5">
                ...
                <div class="mt-3">
                    <a href="{{ route('news.show', $article) }}" class="inline-flex items-center gap-1 text-sm font-medium text-[#073066] hover:underline">
                        Read more
