<div data-chamber-tab="members" class="hidden p-4 sm:p-6">
    <div class="rounded-xl border border-neutral-200 bg-white shadow-sm overflow-hidden">
        <div class="border-b border-neutral-200 px-4 py-3 flex items-center justify-between">
            ...
            <div class="relative">
                <input type="text" placeholder="Search members" class="w-48 rounded-md border border-neutral-200 bg-white pl-3 pr-9 py-1.5 text-xs focus:border-[#073066] focus:ring-2 focus:ring-[#073066]/20">
            ...
            <table class="min-w-full text-sm">
                ...
                <tbody class="divide-y divide-neutral-200">
                    ...
                    <tr class="hover:bg-neutral-50">
                        ...
                        <td class="px-4 py-2 text-[#073066]">{{ $member->email }}</td>
