            ...
            <div class="p-8">
                ...
                <div class="mb-8">
                    ...
                    <div class="w-full bg-gray-200 dark:bg-gray-700 rounded-full h-2">
                        <div class="bg-red-600 h-2 rounded-full transition-all duration-300" id="progress-bar"
                            style="width: 33%"></div>
                    </div>
                </div>

                <!-- Form -->
                <form method="POST" action="{{ route('portal.chamber.store') }}" enctype="multipart/form-data"
                    id="chamber-form">
                    @csrf
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <select name="type" id="type"
                                    class="w-full px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-red-500 dark:bg-gray-700 dark:text-white"
                                    required>
                                    <option value="national" {{ old('type')=='national' ? 'selected' : '' }}>Nationale
                                    </option>
                                    <option value="bilateral" {{ old('type')=='bilateral' ? 'selected' : '' }}>
                                        Bilatérale</option>
                                </select>
                                @error('type')
                                <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                            ...
                            <div data-bilateral-portal class="{{ old('type') === 'bilateral' ? '' : 'hidden' }}">
                                <label for="embassy_country"
                                    class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                                    Pays de l'ambassade (si bilatérale)
                                </label>
                                <select name="embassy_country" id="embassy_country"
                                    class="w-full px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-red-500 dark:bg-gray-700 dark:text-white">
                                    <option value="">Sélectionnez un pays</option>
                                    @foreach(config('countries') as $country)
                                    <option value="{{ $country }}" {{ old('embassy_country')===$country ? 'selected'
                                        : '' }}>{{ $country }}</option>
                                    @endforeach
                                </select>
                                @error('embassy_country')
                                <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                                @enderror
                            </div>

                            <!-- Adresse ambassade (si bilatérale) -->
                            <div class="md:col-span-2" data-bilateral-portal
                                class="{{ old('type') === 'bilateral' ? '' : 'hidden' }}">
                                <label for="embassy_address"
                                    class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                                    Adresse de l'ambassade (si bilatérale)
                                </label>
                                <input type="text" name="embassy_address" id="embassy_address"
                                    class="w-full px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-red-500 dark:bg-gray-700 dark:text-white"
                                    placeholder="Rue, numéro, ville, pays" value="{{ old('embassy_address') }}">
                            ...
                            <div>
                                ...
                                <select name="location" id="location" required
                                    ...
                                    <option value="Kinshasa" {{ old('location')=='Kinshasa' ? 'selected' : '' }}>
                                        Kinshasa</option>
                                    <option value="Haut-Katanga" {{ old('location')=='Haut-Katanga' ? 'selected' : ''
                                        }}>Haut-Katanga</option>
                                    <option value="Lualaba" {{ old('location')=='Lualaba' ? 'selected' : '' }}>Lualaba
                                    </option>
                                    <option value="Haut-Lomami" {{ old('location')=='Haut-Lomami' ? 'selected' : '' }}>
                                        Haut-Lomami</option>
                                    <option value="Tanganyika" {{ old('location')=='Tanganyika' ? 'selected' : '' }}>
                                        Tanganyika</option>
                                    <option value="Sud-Kivu" {{ old('location')=='Sud-Kivu' ? 'selected' : '' }}>
                                        Sud-Kivu</option>
                                    <option value="Nord-Kivu" {{ old('location')=='Nord-Kivu' ? 'selected' : '' }}>
                                        Nord-Kivu</option>
                                    <option value="Ituri" {{ old('location')=='Ituri' ? 'selected' : '' }}>Ituri
                                    </option>
                                    <option value="Tshopo" {{ old('location')=='Tshopo' ? 'selected' : '' }}>Tshopo
                                    </option>
                                    <option value="Bas-Uele" {{ old('location')=='Bas-Uele' ? 'selected' : '' }}>
                                        Bas-Uele</option>
                                    <option value="Haut-Uele" {{ old('location')=='Haut-Uele' ? 'selected' : '' }}>
                                        Haut-Uele</option>
                                    <option value="Sankuru" {{ old('location')=='Sankuru' ? 'selected' : '' }}>Sankuru
                                    </option>
                                    <option value="Lomami" {{ old('location')=='Lomami' ? 'selected' : '' }}>Lomami
                                    </option>
                                    <option value="Kasaï" {{ old('location')=='Kasaï' ? 'selected' : '' }}>Kasaï
                                    </option>
                                    <option value="Kasaï-Central" {{ old('location')=='Kasaï-Central' ? 'selected' : ''
                                        }}>Kasaï-Central</option>
                                    <option value="Kasaï-Oriental" {{ old('location')=='Kasaï-Oriental' ? 'selected'
                                        : '' }}>Kasaï-Oriental</option>
                                    <option value="Kwango" {{ old('location')=='Kwango' ? 'selected' : '' }}>Kwango
                                    </option>
                                    <option value="Kwilu" {{ old('location')=='Kwilu' ? 'selected' : '' }}>Kwilu
                                    </option>
                                    <option value="Mai-Ndombe" {{ old('location')=='Mai-Ndombe' ? 'selected' : '' }}>
                                        Mai-Ndombe</option>
                                    <option value="Kongo-Central" {{ old('location')=='Kongo-Central' ? 'selected' : ''
                                        }}>Kongo-Central</option>
                                    <option value="Équateur" {{ old('location')=='Équateur' ? 'selected' : '' }}>
                                        Équateur</option>
                                    <option value="Mongala" {{ old('location')=='Mongala' ? 'selected' : '' }}>Mongala
                                    </option>
                                    <option value="Nord-Ubangi" {{ old('location')=='Nord-Ubangi' ? 'selected' : '' }}>
                                        Nord-Ubangi</option>
                                    <option value="Sud-Ubangi" {{ old('location')=='Sud-Ubangi' ? 'selected' : '' }}>
                                        Sud-Ubangi</option>
                                    <option value="Tshuapa" {{ old('location')=='Tshuapa' ? 'selected' : '' }}>Tshuapa
                                    </option>
                                    <option value="Maniema" {{ old('location')=='Maniema' ? 'selected' : '' }}>Maniema
                                    </option>
                                </select>
                                @error('location')
                                <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                    ...
                    <div class="step-content hidden" id="step-2">
                        ...
                        <div class="space-y-6">
                            ...
                            <div>
                                ...
                                <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">Document officiel indiquant
                                    l'objet, les organes, les règles internes</p>
                                @error('statuts')
                                <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <!-- Règlement intérieur -->
                            <div>
                                <label for="reglement_interieur"
                                    class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                                    Règlement intérieur * <span class="text-xs text-gray-500">(PDF, DOCX - Max
                                        10MB)</span>
                                </label>
                                <input type="file" name="reglement_interieur" id="reglement_interieur"
                            ...
                            <div>
                                <label for="pv_assemblee"
                                    class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                                    Procès-verbal de l'Assemblée constitutive * <span class="text-xs text-gray-500">(PDF
                                        - Max 10MB)</span>
                                </label>
                                <input type="file" name="pv_assemblee" id="pv_assemblee" accept=".pdf" required
                                    class="w-full px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-red-500 dark:bg-gray-700 dark:text-white file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-sm file:font-semibold file:bg-red-50 file:text-red-700 hover:file:bg-red-100">
                                <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">Mentionne l'élection du bureau
                                </p>
                                @error('pv_assemblee')
                                <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                                @enderror
                            ...
                            <div>
                                <label for="liste_membres"
                                    class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                                    Liste des membres fondateurs * <span class="text-xs text-gray-500">(PDF, Excel - Max
                                        10MB)</span>
                                </label>
                                <input type="file" name="liste_membres" id="liste_membres" accept=".pdf,.xlsx,.xls"
                                    required
                                    class="w-full px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-red-500 dark:bg-gray-700 dark:text-white file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-sm file:font-semibold file:bg-red-50 file:text-red-700 hover:file:bg-red-100">
                            ...
                            <!-- Pièces d'identité -->
                            <div>
                                <label for="pieces_identite"
                                    class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                                    Copie des pièces d'identité des fondateurs * <span
                                        class="text-xs text-gray-500">(PDF - Max 20MB)</span>
                                </label>
                                <input type="file" name="pieces_identite" id="pieces_identite" accept=".pdf" required
                                    class="w-full px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-red-500 dark:bg-gray-700 dark:text-white file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-sm file:font-semibold file:bg-red-50 file:text-red-700 hover:file:bg-red-100">
                                <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">Carte d'identité ou passeport
                                    (fichier unique contenant toutes les pièces)</p>
                            ...
                            <!-- Lettre de demande -->
                            <div>
                                <label for="lettre_demande"
                                    class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                                    Lettre de demande de personnalité juridique * <span
                                        class="text-xs text-gray-500">(PDF, DOCX - Max 10MB)</span>
                                </label>
                                <input type="file" name="lettre_demande" id="lettre_demande" accept=".pdf,.doc,.docx"
                                    required
                                    class="w-full px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-red-500 dark:bg-gray-700 dark:text-white file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-sm file:font-semibold file:bg-red-50 file:text-red-700 hover:file:bg-red-100">
                                <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">Lettre adressée au Ministre de
                                    la Justice</p>
                    ...
                    <div class="step-content hidden" id="step-3">
                        ...
                        <div
                            ...
                            <div class="flex">
                                ...
                                <div class="ml-3">
                                    <h3 class="text-sm font-medium text-blue-800 dark:text-blue-200">Information
                                        importante</h3>
                                    <div class="mt-2 text-sm text-blue-700 dark:text-blue-300">
                                        <p>Une fois votre demande soumise, elle sera examinée par nos administrateurs.
                                            Vous recevrez un e-mail de confirmation dès qu'une décision sera prise
                                            concernant votre demande.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="flex items-center mb-6">
                            ...
                            <label for="confirmation" class="ml-2 block text-sm text-gray-900 dark:text-gray-300">
                                Je certifie que toutes les informations fournies sont exactes et que tous les documents
                                requis ont été téléversés. *
                            </label>
                        </div>
                    </div>
                    ...
                    <div class="flex justify-between pt-6">
                        <button type="button" id="prev-btn"
                            class="px-6 py-3 bg-gray-600 hover:bg-gray-700 text-white font-medium rounded-lg transition-colors duration-200 hidden">
                            Précédent
                        </button>
                        <button type="button" id="next-btn"
                            class="px-6 py-3 bg-red-600 hover:bg-red-700 text-white font-medium rounded-lg transition-colors duration-200 ml-auto">
                            Suivant
                        </button>
                        <button type="button" id="submit-btn"
                            class="px-6 py-3 bg-green-600 hover:bg-green-700 text-white font-medium rounded-lg transition-colors duration-200 ml-auto hidden">
...
<script>
    ...
    // Toggle bilateral fields on type change
    const typeSelect = document.getElementById('type');
    const toggleBilateral = () => {
        const isBil = typeSelect.value === 'bilateral';
        document.querySelectorAll('[data-bilateral-portal]').forEach(el => {
            el.classList.toggle('hidden', !isBil);
        });
    };
    if (typeSelect) {
