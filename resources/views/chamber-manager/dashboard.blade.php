                ...
                <div class="flex items-center">
                    ...
                    <div class="ml-5 w-0 flex-1">
                        <dl>
                            ...
                            <dd class="text-lg font-medium text-gray-900">{{ $stats['total_chambers'] }}</dd>
                        </dl>
                    </div>
                </div>
            </div>
        ...
        <div class="lg:col-span-2">
            <div class="bg-white shadow rounded-lg">
                <div class="px-4 py-5 sm:p-6">
                    <h3 class="text-lg leading-6 font-medium text-gray-900 mb-4">Mes chambres</h3>
                        ...
                        <div class="flex items-center justify-between">
                            <div class="flex items-center space-x-4">
                                ...
                                <div>
                                    ...
                                    <p class="text-sm text-gray-500">{{ $chamber->location ?? 'Localisation non définie'
                                        }}</p>
                        ...
                        <div class="flex items-center justify-between">
                            <div class="flex items-center space-x-3">
                                ...
                                <div>
                                    ...
                                    <p class="text-xs text-gray-500">{{ $member->chamber_name }}</p>
                                </div>
                            </div>
                        </div>
